...
export interface ApiFinancialStatementFinancialStatement
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    statementName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface PluginUalUal extends Struct.CollectionTypeSchema {
  collectionName: 'ual';
  info: {
    description: 'The ual collection';
    displayName: 'UAL';
    pluralName: 'ual';
    singularName: 'ual';
  };
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'plugin::ual.ual'> &
      Schema.Attribute.Private;
